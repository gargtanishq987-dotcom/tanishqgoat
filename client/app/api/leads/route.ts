  ...
  try {
    ...
    for (let i = 0; i < rawLeads.length; i++) {
      ...
      validLeads.push({
        ...
        body: replacePlaceholders(d.body.replace(/\\n/g, "\n"), vars),
        followup1: replacePlaceholders(d.followup_1.replace(/\\n/g, "\n"), vars),
        followup2: replacePlaceholders(d.followup_2.replace(/\\n/g, "\n"), vars),
        followup3: replacePlaceholders(d.followup_3.replace(/\\n/g, "\n"), vars),
        customVariables,
        status: "pending",
        sentAt: null,
        gmailThreadId: null,
